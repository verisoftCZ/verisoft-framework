...
import { ActionButtonComponent, ActionButtonGroupComponent, FilterComponent, FilterFieldDirective, Icons } from '@verisoft/ui-primeng';
...
@Component({
  selector: 'v-doc-primeng-filter-basic-example',
  imports: [
    FilterComponent,
...
export class PrimengFilterBasicExampleComponent {
  filter: unknown;
