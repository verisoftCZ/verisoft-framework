    ...
    x
      .addSection((s) =>
        s
          .title('Import')
          .addCode( isPrimeng ?
            `import { ActionButtonGroupComponent, ActionButtonComponent } from '@verisoft/ui-primeng';` :
            `import { ActionButtonGroupComponent, ActionButtonComponent } from '@verisoft/ui-govcz';`
          )
      )
      .addSection((s) =>
        s
