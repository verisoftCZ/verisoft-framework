...
namespace Verisoft.DemoApi.Database.Migrations
{
    ...
    [Migration("20240619073710_TESTCodeList")]
    partial class TESTCodeList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Verisoft.DemoApi.Core.Entities.BlobEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Verisoft.DemoApi.Core.Entities.TestCodeList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("codelist_NahodnyNazev", (string)null);
                });
            ...
            modelBuilder.Entity("Verisoft.DemoApi.Core.Entities.BlobEntity", b =>
                {
                    b.HasOne("Verisoft.DemoApi.Core.Entities.DocumentEntity", "Document")
                        .WithOne("Blob")
                        .HasForeignKey("Verisoft.DemoApi.Core.Entities.BlobEntity", "DocumentId")
